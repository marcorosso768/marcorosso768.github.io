...
<div id="2024-content" style="display: block;">
  ...
  <p style="padding-left: 10px;"> <i class="fa-solid fa-person-chalkboard" style="color: var(--global-theme-color); margin-left: -10px;"></i>&nbsp; Ciclo de Seminarios del Departamento de Economía - <span style="color: var(--global-theme-color);">Speaker</span>
    <br>
