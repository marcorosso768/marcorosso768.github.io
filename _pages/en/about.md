...
Meanwhile—when I am not trying to engineer a Pareto-superior outcome for my to-do list to avoid the deadweight loss of downtime—I am working on the rollout of the <b style="color: $white-color;"><a href="https://appminuto.it/login">MinUTo App</a></b> in support of mindful parenting, building on the online interviews I conducted for the <a href="https://site.unibo.it/minuto/en">MinUTo Project</a>. Moreover, I am also a <b style="color: $white-color;">Teaching Assistant</b> for <b style="color: $white-color;">Industrial Economics</b>, <b style="color: $white-color;">Econometrics</b>, <b style="color: $white-color;">Political Economy</b>, and <b style="color: $white-color;">Python for Economists</b>. Mostly, I translate complex ideas and code into unlikely metaphors—with a confidence that is only partly justified.
