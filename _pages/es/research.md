...
<!-- Paper -->
  ...
  <div class="pill-container mt-2">
      <a 
  href="mailto:marco.rosso4@unibo.it
        ?subject=Solicitud%20de%20borrador%20-%20Proximity%20to%20Public%20Childcare%20and%20Voter%20Turnout%3A%20Evidence%20from%20Bologna
        &body=Hola%20Marco%3A%0D%0A%0D%0AQuisiera%20pedirte%20el%20borrador%20de%20tu%20documento%20de%20trabajo%20%E2%80%9CProximity%20to%20Public%20Childcare%20and%20Voter%20Turnout%3A%20Evidence%20from%20Bologna%E2%80%9D.%0D%0A%0D%0A%C2%A1Gracias%21%0D%0A"
  class="pill-link no-external">
        <i class="fa-solid fa-file-lines fa-2xs"></i>
        <span class="toggle-label" title="Borrador disponible a pedido">Borrador</span>
      </a>
    ...
    ¿La cercanía a bienes públicos de provisión local aumenta la participación política de los hogares a los que están destinados? Estudiamos Bolonia, Italia, con registros administrativos de participación de todas las personas habilitadas para votar en cuatro elecciones (2004–2013), vinculados a los padrones anuales de población, al ingreso, a las fechas exactas de nacimiento y a un censo geocodificado de establecimientos de cuidado infantil construido para este trabajo. Nuestra especificación de base sigue a madres y padres con un hijo conviviente en el padrón anual a medida que el hijo crece y atraviesa distintos regímenes de servicio, de modo que la distancia relevante cambia dentro de la misma persona, y estima pendientes de distancia separadas para las elecciones locales y nacionales. La pendiente de distancia a los establecimientos municipales en las elecciones locales es estadísticamente indistinguible de cero, con una cota de equivalencia simétrica de 0,47 puntos porcentuales por cada 100 metros, o 1,25 puntos a lo largo del rango intercuartílico de la distancia. El contraste local–nacional que restringe la hipótesis de rendición de cuentas se estima con menor precisión: su cota es de 0,79 puntos por cada 100 metros, y efectos moderados sobre él siguen siendo compatibles con la evidencia. La cercanía no modera de manera detectable la penalidad por maternidad y paternidad, ninguna interacción por género sobrevive al ajuste por multiplicidad, y una cohorte que cambia de régimen y otros seis servicios y equipamientos locales arrojan el mismo resultado. Un contraste marginal anterior entre madres y padres con continuidad de domicilio verificada no es robusto a la especificación y se reporta como exploratorio. El estimando es la cercanía: las estimaciones acotan el efecto movilizador de vivir cerca de un establecimiento y dejan sin medir el de obtener una vacante en él.
    </div>
