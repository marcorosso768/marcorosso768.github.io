...
<div id="publications-content" style="display: block;">
  ...
  <p style="margin: 0; margin-left: 10px;">
    <a href="javascript:void(0);" id="toggle-abstract-1" onclick="toggleAbstract('abstract-1')">
      <i class="fa-solid fa-chevron-right fa-sm"></i> <i>Abstract</i>
    </a>
  </p>
...
<script>
  ...
  function toggleAbstract(id) {
    ...
    if (abstract.style.display === "none" || abstract.style.display === "") {
      ...
      toggleButton.className = "fa-solid fa-chevron-down fa-sm"; // Change to down icon
    } else {
      abstract.style.display = "none";
      toggleButton.className = "fa-solid fa-chevron-right fa-sm"; // Change to right icon
    }
  }
